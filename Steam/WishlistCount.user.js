...
invaildGamelist = '';
normalList = [], invaildList = [], disList = [], freeList = [], futureList = [];
var list = g_Wishlist.rgAllApps;
// var items = list.getElementsByClassName('wishlist_row');
	...
	function (idx, i) {
        ...
        if (null != childEle) {
			...
			if (g_rgAppInfo[idx].free) {
			    ...
			    // 	return;
			    // }
			    // var name = ele.getElementsByClassName('title')[0];
			    // if (null != name) {
			    //     // 失效游戏
			    //     invaildGamelist += '\n    ' + name.innerText;
			    //     ++invaildGameCnt;
